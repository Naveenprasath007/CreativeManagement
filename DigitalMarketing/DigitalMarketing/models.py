...
class TbStatus(models.Model):
    ...
    thumbnail = models.CharField(db_column='thumbnail', max_length=2000,blank=True, null=True)  # Field name made lowercase.
    thumbnail1 = models.CharField(db_column='thumbnail1', max_length=255, blank=True, null=True)
    thumbnail2 = models.CharField(db_column='thumbnail2', max_length=2000,blank=True, null=True)  # Field name made lowercase.
