        ...
        if request.method == "POST":
            ...
            if upload == "Upload":
                    if type == 'Image':
                        ...
                        file_path = BASE_DIR + video_url
                        print("path of the file is " ,file_path)
                        print("base dir" ,BASE_DIR)
                        name="thumbnail"
                        thumbnail_path=thumbnail_creator(file_path,name)
                    ...
                    # if Creative != 'Video':
                        ...
                        vendor=Vendor,lob=Lob,creative=Creative,
                        platform=Platform,creater=Creator,Gifurl=Gif_url,
                        Imageurl=image_url,thumbnail=thumbnail_path,thumbnail1='--',thumbnail2='--')
                        ...
                        status = TbStatus(userid=TbUser.objects.get(userid=id),videoid=VID,status='Pending',videoname=Title,approver='---',uploadername=UN,
                                        videoPath=video_url,videoPath1='--',videoPath2='--',platform=Platform,Imageurl=image_url,Gifurl=Gif_url,creative=Creative,thumbnail=thumbnail_path,thumbnail1='--',thumbnail2='--')
                        status.save()
                ...
                if ascpect1:
                    ...
                    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
                    file_path = BASE_DIR + video_url1
                    print("path of the file is " ,file_path)
                    print("base dir" ,BASE_DIR)
                    name="thumbnail1"
                    thumbnail_path1=thumbnail_creator(file_path,name)
                else:
                    video_url1='--'
                    thumbnail_path1='--'
                if ascpect2:
                    ...
                    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
                    file_path = BASE_DIR + video_url2
                    print("path of the file is " ,file_path)
                    print("base dir" ,BASE_DIR)
                    name="thumbnail2"
                    thumbnail_path2=thumbnail_creator(file_path,name)
                else:
                    video_url2='--'
                    thumbnail_path2='--'
                ...
                tbvideo.thumbnail1=thumbnail_path1
                tbvideo.thumbnail2=thumbnail_path2
                tbvideo.save()

                status = TbStatus.objects.get(videoid=VID)
                status.videoPath1=video_url1
                status.videoPath2=video_url2
                status.thumbnail1=thumbnail_path1
                status.thumbnail2=thumbnail_path2
                status.save() 
...
def thumbnail_creator(file_path,name):
        try:
            with VideoFileClip(file_path) as video:
                BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
                frame = video.get_frame(0)
                thumbnail_filename = os.path.splitext(os.path.basename(file_path))[0] +name+".jpg"
                thumbnail_folder = BASE_DIR +'/media/thumbnails/'
                thumbnail_path = os.path.join(thumbnail_folder, thumbnail_filename)
                video.save_frame(thumbnail_path, t=0)
                return '/media/thumbnails/'+thumbnail_filename
        except Exception as e:
            return "this video is not supported for thumbnails."
